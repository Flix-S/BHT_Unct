...
TVD = 2500                                # depth of BHT measurement [m TVD]
radius = 0.07620                            # borehole radius [m]
BHT_list = [80,82,83]                          # in-situ temperatures [degC]
t_list = [8,10,15]                           # shut-in times [h]
...
sample_variation = [100,500,5000,10000]           # specify the sample number
