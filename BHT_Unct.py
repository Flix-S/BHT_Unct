...
# Insert name of well:
well = 'Erding 1'                   
method = 'FM'                               # specify correction method  '1BHTM' (automatically specified when n = 1)
                                            #                            'LM' (low confidence in shut-in time, n>2)
                                            #                            'FM','BM' (high confidence in shut-in time, n>1)
TVD = 2355.6                                # depth of BHT measurement [m TVD]
radius = 0.07620                            # borehole radius [m]
BHT_list = [70,72]                          # in-situ temperatures [degC]
t_list = [8,10.5]                           # shut-in times [h]
Tmud = 55                                   # estimate Tm as Outflow temperature, if such is available, otherwise: Tm = 0, initial range for Tm is [20,80]
quality_BHT = 'med'                         # confidence in quality of BHT and shut-in time 'low', 'med', 'high'
quality_ts = 'med'

sample_variation = [100,500,5000]           # specify the sample number
...
if case == 'BM' and len(BHT_list) == 6:                             #Brennand
    ...
    problem = {'num_vars': no_var,
               ...
               'bounds': [[BHT_lmin[0],BHT_lmax[0]],
                          ...
                          [t_lmin[5],t_lmax[5]],                            
                          tc_list]}            
if case == 'LM' and len(BHT_list) == 3:                            #Linearization
    p_names = ['1st_BHT','t1','2nd_BHT','t2','3rd_BHT',
               't3','radius','Tm']
    no_var = 8
    problem = {'num_vars': no_var,
               ...
               'bounds': [[BHT_lmin[0],BHT_lmax[0]],
                          ...
                          a_list,
                          Tm_list]}
if case == 'LM' and len(BHT_list) == 4:                            #Linearization
    p_names = ['1st_BHT','t1','2nd_BHT','t2','3rd_BHT',
    ...
    problem = {'num_vars': no_var,
               ...
               'bounds': [[BHT_lmin[0],BHT_lmax[0]],
                          ...
                          a_list,
                          Tm_list]}
if case == 'LM' and len(BHT_list) == 5:                            #Linearization
    p_names = ['1st_BHT','t1','2nd_BHT','t2','3rd_BHT',
               't3','4th_BHT','t4','5th_BHT','t5',
               'radius','Tm']
    no_var = 12
    problem = {'num_vars': no_var,
               ...
               'bounds': [[BHT_lmin[0],BHT_lmax[0]],
                          ...
                          a_list,
                          Tm_list]}
if case == 'LM' and len(BHT_list) == 6:                            #Linearization
    p_names = ['1st_BHT','t1','2nd_BHT','t2','3rd_BHT',
               't3','4th_BHT','t4','5th_BHT','t5',
